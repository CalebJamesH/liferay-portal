...
public class ProvisioningHubService extends BaseService {
	...
	private static final String _LIFERAY_DATA_PLATFORM_PRIVATE_BETA = "Liferay Data Platform (Private Beta)";
